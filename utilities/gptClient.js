    ...
    const messages = [
        {
            role: "system",
            content:
                `You are a quiz question creator. Your job is to generate quiz questions based on the inputted 
                topic. Give the answers as well and make it return JSON.`,
        },
        {
            role: "user",
            content: 
                `Generate ${num_ques} questions with multiple-choice answers based on the topic: '${subject}'. 
        ...
        },
        {
            role: "system",
            content:
                `The format for each question should be a clear, concise question followed by four 
